...
results_path_prefix = './logs/regressor_varying_pair_measurements/regressor_test_varying_rho_clipped_'
results_path = '{}{}.log'
plot_path = './plots/regressor_varying_pair_measurements/regressor_test_varying_rho_clipped_{}.png'
...
for i in range(0, model_params['input_dim']):
    ...
    plot_metrics_from_file(results_path.format(results_path_prefix,  f'{i}'), title=f'Metrics for rho element {i}', save_path=plot_path.format(f'{i}'), xaxis='variance')

plot_metrics_from_files(f'{results_path_prefix}', (0, model_params['input_dim']), title=f'RMSE loss for varying rho elements', save_path=plot_path.format(f'{i}_rmse'), xaxis='variance', specified_metric='test_rmse_loss')
plot_metrics_from_files(f'{results_path_prefix}', (0, model_params['input_dim']), title=f'Accuracy for varying rho elements', save_path=plot_path.format(f'{i}_acc'), xaxis='variance', specified_metric='test_accuracy')
