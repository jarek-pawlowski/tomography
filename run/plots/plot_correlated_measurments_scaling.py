...
def main():
    ...
    log_path_lstm_2_layers_random_memory = f'./logs/{num_qubits}qbits/lstm2_reconstructor_optimized.log'
    ...
    log_path_combined_lstm_2_layers_no_measurements_memory = f'./logs/{num_qubits}qbits/combined_lstm2_discrete_unique_measurement_selector_no_measurements_measure_memory_measurement_dependence.log'
    ...
    metrics_lstm_2_layers_random_memory = load_metrics_from_file(log_path_lstm_2_layers_random_memory)
    ...
    metrics_lstm_2_layers_combined_memory = load_metrics_from_file(log_path_combined_lstm_2_layers_no_measurements_memory)
    ...
    plt.plot(np.arange(1, 4**num_qubits+1), metrics_lstm_2_layers_random_memory[new_metric_name],  color='m', marker='*', markevery=2, markersize=5, linestyle='--', fillstyle='none', label='LSTM with random basis')
    ...
    # plt.plot(np.arange(1, 4**num_qubits+1), metrics_lstm_2_layers_combined_memory[metric_to_plot], color='tab:cyan', marker='^', markevery=2, linestyle=':', markersize=5, fillstyle='none', label='LSTM 2 layers with James et al. basis\n(basis only, with memory)')
    ...
    plt.plot(np.arange(1, 4**num_qubits+1), metrics_lstm_2_layers_memory[metric_to_plot], color='r', marker='s', markevery=2, linestyle='-', markersize=5, fillstyle='none', label='LSTM with adjusted basis')
