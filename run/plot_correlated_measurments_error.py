...
def main():
    ...
    # log_path_kwiat_basis_lstm = './logs/full_lstm_measure_basis_kwiat_basis_loss.log'
    ...
    plt.plot(np.arange(1, 17), metrics_kwiat_basis_lin_comb_lstm['bures_distance'], label='LSTM with linear combination of Kwiat basis')
