...
from src.tomography_utils_torch import reconstruct_from_pinv
...
eigvals_save_prefix = f'./logs/2qbits/eigvals/pinv_reconstruction_t2'
...
for measurement_subset in measurement_subsets:
    ...
    generate_eigvals(
        test_loader,
        reconstruction_fn=lambda measurement, rho: reconstruct_from_pinv(
            measurement, num_qubits, measurements_subset=measurement_subset),
