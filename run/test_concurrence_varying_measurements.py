...
from src.torch_measure import test_measurement_noise
...
results_path = './logs/concurrence_varying_measurements/concurrence_test_varying_measurement_clipped_{}.log'
...
for i in range(0, num_measurements):
    ...
    test_metrics = test_measurement_noise(test_loader, criterions, varying_input_idx=[i], max_variance=1., step=0.05)
